...
/ффа - просмотреть открытые ФФА.
/ффа текущие - просмотреть текущие ФФА.
/ффа айди_игры - просмотреть информацию об ФФА с данным айди.
/ффа открыть описание - открыть ФФА с заданным описанием.
/ффа войти айди_игры - присоединиться к ФФА с данным айди.
/ффа начать айди_игры название_в_политопии - начать указанную ФФА.
/ффа завершить айди_игры победитель - завершить указанную ФФА.'''
