...
Несколько примеров того, как это происходит:
* Если у победителя были шансы 100%, его рейтинг не меняется.
* Если у победителя были шансы 80%, он получает +10 рейтинга.
* Если у победителя были шансы 60%, он получает +20 рейтинга.
* Если у победителя были шансы 40%, он получает +30 рейтинга.
* Если у победителя были шансы 20%, он получает +40 рейтинга.
* Если у победителя были шансы 0%, он получает +50 рейтинга.
